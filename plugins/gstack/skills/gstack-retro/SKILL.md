...
```bash
DISCOVER_BIN=""
[ -x ~/.copilot/skills/gstack/bin/gstack-global-discover ] && DISCOVER_BIN=~/.copilot/skills/gstack/bin/gstack-global-discover
[ -z "$DISCOVER_BIN" ] && [ -x .copilot/skills/gstack/bin/gstack-global-discover ] && DISCOVER_BIN=.copilot/skills/gstack/bin/gstack-global-discover
